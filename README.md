...
LearnMate AI solves this problem by acting as an intelligent educational mentor that provides customized learning pathways based on student preferences and skill levels.

# 💡 Proposed Solution

The application collects user inputs such as:
